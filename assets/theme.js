...
theme.MobileNav = (function() {
  ...
  function init() {
    cacheSelectors();
    cache.$mobileNavToggle.once('click', toggleMobileNav);
    cache.$subNavToggleBtn.once('click.subNav', toggleSubNav);
  ...
  function openMobileNav() {
    ...
    //TODO: Transform this to fade in/out
    //cache.$mobileNavContainer.css({ transform: 'translate3d(0, ' + translateHeaderHeight + 'px, 0)' });
    cache.$mobileNavContainer.css({ opacity: "1" });
    //cache.$pageContainer.css({ transform: 'translate3d(0, ' + cache.$mobileNavContainer[0].scrollHeight + 'px, 0)' });
  ...
  function closeMobileNav() {
    ...
    //TODO: Transform this to FadeInOut
    //cache.$mobileNavContainer.css({transform: 'translate3d(0, -100%, 0)'});
    cache.$mobileNavContainer.css({opacity: '0'});
